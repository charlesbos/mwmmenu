...
MenuWriter::MenuWriter(const std::string& menuName, bool useIcons, int windowmanager,
...
MwmMenuWriter::MwmMenuWriter(const std::string& menuName, bool useIcons, int windowmanager,
        std::vector<std::string> exclude, std::vector<std::string> excludeMatching,
        std::vector<std::string> excludeCategories, std::vector<std::string> include, 
        std::vector<std::string> excludedFilenames, const std::vector<Category*>& cats) : 
    MenuWriter(menuName, useIcons, windowmanager, exclude, excludeMatching, excludeCategories, 
            include, excludedFilenames, cats)
{
    for (unsigned int x = 0; x < usedCats.size(); x++)
        writeMenu(usedCats[x], x, usedCats, maxCatNumber);
    if (!usedCats.empty()) writeMenu(NULL, MAIN_MENU, usedCats);
}

void MwmMenuWriter::writeMenu(Category *cat, int catNumber, 
        const std::vector<Category*>& usedCats, int maxCatNumber)
{   
    MenuWriter::writeMenu(cat, catNumber, usedCats, maxCatNumber);
    if (cat != NULL)
    {  
        for (unsigned int x = 0; x < subCats.size(); x++)
        {
...
// FvwmMenuWriter
//------------------------------------------------------------------------------
FvwmMenuWriter::FvwmMenuWriter(const std::string& menuName, bool useIcons, int windowmanager,
        std::vector<std::string> exclude, std::vector<std::string> excludeMatching,
        std::vector<std::string> excludeCategories, std::vector<std::string> include, 
        std::vector<std::string> excludedFilenames, const std::vector<Category*>& cats) :
    MenuWriter(menuName, useIcons, windowmanager, exclude, excludeMatching, excludeCategories, 
...
void FvwmMenuWriter::writeMenu(Category *cat, int catNumber, 
        const std::vector<Category*>& usedCats, int maxCatNumber)
{   
    MenuWriter::writeMenu(cat, catNumber, usedCats, maxCatNumber);
    if (cat != NULL)
...
// FluxboxMenuWriter
//------------------------------------------------------------------------------
FluxboxMenuWriter::FluxboxMenuWriter(const std::string& menuName, bool useIcons, int windowmanager,
        std::vector<std::string> exclude, std::vector<std::string> excludeMatching,
        std::vector<std::string> excludeCategories, std::vector<std::string> include, 
        std::vector<std::string> excludedFilenames, const std::vector<Category*>& cats) :
    MenuWriter(menuName, useIcons, windowmanager, exclude, excludeMatching, excludeCategories, 
...
void FluxboxMenuWriter::writeMenu(Category *cat, int catNumber, 
        const std::vector<Category*>& usedCats, int maxCatNumber)
{   
    MenuWriter::writeMenu(cat, catNumber, usedCats, maxCatNumber);
    if (catNumber == 0) 
...
// OpenboxMenuWriter
//------------------------------------------------------------------------------
OpenboxMenuWriter::OpenboxMenuWriter(const std::string& menuName, bool useIcons, int windowmanager,
        std::vector<std::string> exclude, std::vector<std::string> excludeMatching,
        std::vector<std::string> excludeCategories, std::vector<std::string> include, 
        std::vector<std::string> excludedFilenames, const std::vector<Category*>& cats) :
    MenuWriter(menuName, useIcons, windowmanager, exclude, excludeMatching, excludeCategories, 
            include, excludedFilenames, cats)
{
    for (unsigned int x = 0; x < usedCats.size(); x++)
        writeMenu(usedCats[x], x, usedCats, maxCatNumber);
    if (!usedCats.empty() && windowmanager == openbox) 
        writeMenu(NULL, MAIN_MENU, usedCats);
}

void OpenboxMenuWriter::writeMenu(Category *cat, int catNumber, 
        const std::vector<Category*>& usedCats, int maxCatNumber)
{   
    MenuWriter::writeMenu(cat, catNumber, usedCats, maxCatNumber);
...
// OlvwmMenuWriter
//------------------------------------------------------------------------------
OlvwmMenuWriter::OlvwmMenuWriter(const std::string& menuName, bool useIcons, int windowmanager,
        std::vector<std::string> exclude, std::vector<std::string> excludeMatching,
        std::vector<std::string> excludeCategories, std::vector<std::string> include, 
        std::vector<std::string> excludedFilenames, const std::vector<Category*>& cats) :
    MenuWriter(menuName, useIcons, windowmanager, exclude, excludeMatching, excludeCategories, 
...
void OlvwmMenuWriter::writeMenu(Category *cat, int catNumber, 
        const std::vector<Category*>& usedCats, int maxCatNumber)
{   
    MenuWriter::writeMenu(cat, catNumber, usedCats, maxCatNumber);
    if (catNumber == 0) 
...
// WmakerMenuWriter
//------------------------------------------------------------------------------
WmakerMenuWriter::WmakerMenuWriter(const std::string& menuName, bool useIcons, int windowmanager,
        std::vector<std::string> exclude, std::vector<std::string> excludeMatching,
        std::vector<std::string> excludeCategories, std::vector<std::string> include, 
        std::vector<std::string> excludedFilenames, const std::vector<Category*>& cats) :
    MenuWriter(menuName, useIcons, windowmanager, exclude, excludeMatching, excludeCategories, 
...
void WmakerMenuWriter::writeMenu(Category *cat, int catNumber, 
        const std::vector<Category*>& usedCats, int maxCatNumber)
{   
    MenuWriter::writeMenu(cat, catNumber, usedCats, maxCatNumber);
...
// IcewmMenuWriter
//------------------------------------------------------------------------------
IcewmMenuWriter::IcewmMenuWriter(const std::string& menuName, bool useIcons, int windowmanager,
        std::vector<std::string> exclude, std::vector<std::string> excludeMatching,
        std::vector<std::string> excludeCategories, std::vector<std::string> include, 
        std::vector<std::string> excludedFilenames, const std::vector<Category*>& cats) :
    MenuWriter(menuName, useIcons, windowmanager, exclude, excludeMatching, excludeCategories, 
...
void IcewmMenuWriter::writeMenu(Category *cat, int catNumber, 
        const std::vector<Category*>& usedCats, int maxCatNumber)
{   
    MenuWriter::writeMenu(cat, catNumber, usedCats, maxCatNumber);
    if (useIcons)
